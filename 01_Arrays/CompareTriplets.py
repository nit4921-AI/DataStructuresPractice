...
1 1
Explanation 0
Comparing the 0th elements, 5 < 3 so Bob receives a point.
Comparing the 1st elements, 6 = 6 so nobody receives a point.
Comparing the 2nd elements, 7 > 10 so Alice receives a point.
The return array is [1, 1] with Alice's score first and Bob's second.
'''
